...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
	  <form method="post" action="http://localhost:8080/Aula01/login">
	    ...
	    <div>
	    	<a href="${pageContext.request.contextPath}/novousuario.jsp">Cadastrar-se</a>
	    </div>
	    
	     <div>
	    	<a href="${pageContext.request.contextPath}/recuperarsenha.jsp">Esqueceu a senha?</a>
	    </div>
