...
<body>
	    ...
	    <div class="container">
	      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
	        ...
	        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
	          ...
	          <li><a href="http://localhost:8080/Aula01/paginar" class="nav-link px-2 link-secondary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Lista de Usuários</font></font></a></li>
	          <li><a href="http://localhost:8080/Aula01/alterar.jsp" class="nav-link px-2 link-dark"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Alteração de Usuários</font></font></a></li>
	...
	<div class="text-center h4">
		...
		<table class="table">
			...
			<tr class="text">
				<td> <img class="mb-4" src="${pageContext.request.contextPath}/img/<%=listaDePessoas.get(i).getImagem()%>" alt="" width="40" height="40"></td>
				<td><%=listaDePessoas.get(i).getId()%></td>
				<td><%=listaDePessoas.get(i).getNome()%></td>
				<td>
					<a href="http://localhost:8080/Aula01/procurar?id=<%=listaDePessoas.get(i).getId()%>">Detalhes</a> <br/>
					<a href="http://localhost:8080/Aula01/editar?id=<%=listaDePessoas.get(i).getId()%>">Editar</a> <br/>
					<a href="http://localhost:8080/Aula01/apagar?id=<%=listaDePessoas.get(i).getId()%>">Apagar</a>
				</td>
			</tr>
			<%
			}
		...
		int totalDeRegistros = (int) request.getAttribute("totalDeRegistros");
		%>
		
			<a href="http://localhost:8080/Aula01/paginar?inicio=<%=1%>">Primeira</a>
			
		<%
		for (int i = 1; i <= totalDePaginas; i++){
		%>
			
			<a href="http://localhost:8080/Aula01/paginar?inicio=<%=i%>"><%=i%></a>
		
		<%
		}
		%>
		  <a href="http://localhost:8080/Aula01/paginar?inicio=<%=totalDePaginas%>">Última</a>
