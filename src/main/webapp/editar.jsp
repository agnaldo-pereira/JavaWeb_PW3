	    ...
	    <div class="container">
	      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
	        ...
	        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
	          ...
	          <li><a href="http://localhost:8080/Aula01/listausuarios" class="nav-link px-2 link-secondary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Lista de Usuários</font></font></a></li>
	...
	<main class="form-signin w-100 m-auto">
		...
		<div class="text-center h4">
			...
			%>
			 ...
			 <h1 class="h3 mb-3 fw-normal">Atualizando o contato id: <%=pessoa.getId() %></h1> 
		
				<form action="http://localhost:8080/Aula01/atualizar?id=<%=pessoa.getId()%>" method="post">
					Nome: <input name="nome" value="<%=pessoa.getNome()%>"> <br/>
					Email: <input name="email" value="<%=pessoa.getEmail()%>"> <br/>
